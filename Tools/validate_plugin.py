...
def check_source_contract() -> None:
    ...
    require('ExecuteBefore.Add(TEXT("MassBattleAgentRenderProcessor"))' in processor, "Pack processor ordering is missing")
    require("Styles[EntityIndex].Index = MBSTPacking::Pack" in processor, "StyleArray packing write is missing")
